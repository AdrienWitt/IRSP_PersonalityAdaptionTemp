...
# Only including those with above 97, 510 people are left. 
testweekfull <- testweek[ which(testweek$progress > 97), ]


## RMTQ 
## Item 10is reverse keyed --> 6??
...
## General note: Scale is not ideal and could use some further development. 
...
##Select items included in the EFA 
...
##Create a dataframe with all scales
...
## Create a dataframe for CRFs with STRAQ-1 and ECR items
